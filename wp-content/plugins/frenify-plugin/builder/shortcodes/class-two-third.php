...
class frenifySC_TwoThird {
	...
	public function __construct() {
		...
		add_filter( 'fotofly_fn_attr_two-third-shortcode', array( $this, 'attr' ) );
		add_filter( 'fotofly_fn_attr_two-third-in', array( $this, 'attr_2' ) );
		add_filter( 'fotofly_fn_attr_two-third-in-in', array( $this, 'attr_3' ) );
	...
	function render( $args, $content = '') {
		...
		$styles = '';          
		$styles .= '.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . '{
						text-align: ' . self::$args['text_align'] . ';
					}';
		
		$styles .= '.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ',
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' h1,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' h2,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' h3,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' h4,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' h5,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' h6,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' p,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' a,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' a:hover,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' blockquote,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' em,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' strong,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' span,
					.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' .fotofly_fn_custom_content{
						color: ' . self::$args['text_color'] . ';
					}';
		
		$styles .= '.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' .fotofly_fn_overlay_color{
		...
		if(self::$args['background_type'] == 'video'){
			$styles .= '.fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' .fotofly_fn_overlay_video{
		...
		$html = sprintf('<div %s data-inlinestyles="%s">
						...
						frenifyCore_Plugin::attributes( 'two-third-shortcode' ), 
						$styles,
						frenifyCore_Plugin::attributes( 'two-third-in' ), 
						frenifyCore_Plugin::attributes( 'two-third-in-in' ),
						$inner_content, 
						$overlay, 
						$clearfix 
					   );
	...
	function attr() {
		...
		$attr['class'] = 'fn-col-8 frenify-layout-column fotofly_fn_column_two_third_' . $this->fotofly_fn_counter . ' ';
...
//		}		
	...
	function attr_2() {
		...
		if(self::$args['animation_type'] && self::$args['animation_type'] != 'ntwo'){
