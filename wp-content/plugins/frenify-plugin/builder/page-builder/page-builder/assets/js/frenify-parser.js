...
( function($) {
    ...
    frenifyParser.buildShortcodeContainer = function( element ) {
        ...
        if ( element.subElements ) {
            $.each( element.subElements, function( index, obj ) {
                ...
                obj.id = obj.id.replace('fotofly_fn_', '' ).replace('[0]','');
	...
	*/
	frenifyParser.parseColumnOptions = function() {
		...
		$.each(elements, function( index, element ) { //traverse elements
            if ( !element.hasOwnProperty('parentId') || element.php_class == 'fotofly_fn_FullWidthContainer' ) { //if element does not have any parent (column element)
                if ( element.base && element.base != "" ) {
                    shortCodes +=  frenifyParser.buildShortcodeContainer ( element );
                    if ( ~element.php_class.indexOf( 'fotofly_fn_Grid' ) || element.php_class == "fotofly_fn_FullWidthContainer" ) {
	...
	**/
			...
			if( child != null ) {
				...
				if ( builderElement.length > 0 ) {
                    ...
                    if ( builderElement[0].base && builderElement[0].base != "" ) {
                        ...
                        if ( ~builderElement[0].php_class.indexOf( 'fotofly_fn_Grid' ) || builderElement[0].php_class == "fotofly_fn_FullWidthContainer" ) {
	...
	frenifyParser.parseBuilderElements = function( element ) {
        ...
        switch( element.php_class ) {
            ...
            case 'fotofly_fn_GridThreeFifth' :
            ...
            case 'fotofly_fn_GridThreeFourth' :
            ...
            case 'fotofly_fn_Alert':
                ...
                break;
            case 'fotofly_fn_BlogFn':
                return frenifyParser.buildBlogFnShortcode( element.subElements ) ;
                break;
			...
			case 'fotofly_fn_Flexslider' :
                return frenifyParser.buildFlexsliderShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_UnitInfo' :
                return frenifyParser.buildUnitInfoShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CategoryColumnPortfolio' :
                return frenifyParser.buildCategoryColumnPortfolioShortcode( element.subElements ) ;
                break;
			
			case 'fotofly_fn_CategoryColumnGallery' :
                return frenifyParser.buildCategoryColumnGalleryShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_AboutSlider' :
                return frenifyParser.buildAboutSliderShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_ServiceList' :
                return frenifyParser.buildServiceListShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_Wotoslider' :
                return frenifyParser.buildWotosliderShortcode( element.subElements ) ;
                break;
			...
			case 'fotofly_fn_CallToAction' :
                return frenifyParser.buildCallToActionShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_HoverWidth' :
                return frenifyParser.buildHoverWidthShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_ImgAfterBefore' :
                return frenifyParser.buildImgAfterBeforeShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CallToActionClassic' :
                return frenifyParser.buildCallToActionClassicShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_FlipboxFn' :
                return frenifyParser.buildFlipboxFnShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_ButtonFn' :
                return frenifyParser.buildButtonFnShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_ContactInfo' :
                return frenifyParser.buildContactInfoShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_AboutMe' :
                return frenifyParser.buildAboutMeShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_SocialList' :
                return frenifyParser.buildSocialListShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_Instagram' :
                return frenifyParser.buildInstagramShortcode( element.subElements ) ;
                break;
            ...
            case 'fotofly_fn_FullPageGallery' :
                return frenifyParser.buildFullPageGalleryShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CustompostParallax' :
                return frenifyParser.buildCustompostParallaxShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_PortfolioCustom' :
                return frenifyParser.buildPortfolioCustomShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CustompostRibbon' :
                return frenifyParser.buildCustompostRibbonShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CustompostCarousel' :
                return frenifyParser.buildCustompostCarouselShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CustompostCarouselTwo' :
                return frenifyParser.buildCustompostCarouselTwoShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_MultiScroll' :
                return frenifyParser.buildMultiScrollShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CortexSlider' :
                return frenifyParser.buildCortexSliderShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CustompostCategoryFolder' :
                return frenifyParser.buildCustompostCategoryFolderShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CustompostCategoryModern' :
                return frenifyParser.buildCustompostCategoryModernShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_ProjectSlider' :
                return frenifyParser.buildProjectSliderShortcode( element.subElements ) ;
                break;
            ...
            case 'fotofly_fn_SectionSeparator' :
			...
			case 'fotofly_fn_ServiceCarousel' :
                return frenifyParser.buildServiceCarouselShortcode( element.subElements ) ;
                break;
            ...
            case 'fotofly_fn_TestimonialSingle' :
                return frenifyParser.buildTestimonialSingleShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_ServiceTabSingle' :
                return frenifyParser.buildServiceTabSingleShortcode( element.subElements ) ;
                break;
			...
			case 'fotofly_fn_MainTitle':
                return frenifyParser.buildMainTitleShortcode( element.subElements ) ;
                break;
				
			case 'fotofly_fn_CustomLink':
                return frenifyParser.buildCustomLinkShortcode( element.subElements ) ;
                break;

            /*case 'fotofly_fn_Tooltip':
	...
	**/
	frenifyParser.buildAlertShortcode = function( args ) {
		...
		shortcodeData+= ' box_shadow="'+args[4].value+'"';
	...
	**/
	frenifyParser.buildBlogFnShortcode = function( args ) {

		shortcodeData = '[fn_blog';
		...
		shortcodeData+= ' order="'+args[3].value+'"';
		shortcodeData+= ' offset="'+args[4].value+'"';
		shortcodeData+= ' button_text="'+args[5].value+'"';
		shortcodeData+= ' button_url="'+args[6].value+'"';
	...
	**/
	frenifyParser.buildCodeBlockShortcode = function( args ) {
		...
		shortcodeData = '[fotofly_fn_code]';

		if( !Boolean( Number( fotofly_fn_vars.disable_encoding ) ) ) {
	...
	* @return 		String		Tabs doable shortcode
	**/
	frenifyParser.buildFlexsliderShortcode = function( args ) {
		shortcodeData = '[flexslider';
		shortcodeData+= ' purchase_button="'+args[0].value+'"';
		shortcodeData+= ' slide_interval="'+args[1].value+'"';
		shortcodeData+= ' margin_top="'+args[2].value+'"';
		shortcodeData+= ' margin_bottom="'+args[3].value+'"';
	...
	* @return 		String		Tabs doable shortcode
	**/
	frenifyParser.buildUnitInfoShortcode = function( args ) {
		shortcodeData = '[unit_info';
		shortcodeData+= ' title="'+args[0].value+'"';
		shortcodeData+= ' descr="'+args[1].value+'"';
		shortcodeData+= ' link_url="'+args[2].value+'"';
		shortcodeData+= ' link_text="'+args[3].value+'"';
		shortcodeData+= ' t_color="'+args[4].value+'"';
		shortcodeData+= ' d_color="'+args[5].value+'"';
		shortcodeData+= ' l_color="'+args[6].value+'"';
		shortcodeData+= ' l_bgcolor="'+args[7].value+'"';
		shortcodeData+= ' margin_top="'+args[8].value+'"';
		shortcodeData+= ' margin_bottom="'+args[9].value+'"';
		shortcodeData+= ' class="'+args[10].value+'"';
		shortcodeData+= ' id="'+args[11].value+'"]';
	...
	/**
	* Returns Category Column Portfolio shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	...
	* @return 		String		Tabs doable shortcode
	**/
	frenifyParser.buildCategoryColumnPortfolioShortcode = function( args ) {
		shortcodeData = '[category_column_portfolio';
		shortcodeData+= ' margin_top="'+args[0].value+'"';
		shortcodeData+= ' margin_bottom="'+args[1].value+'"';
		shortcodeData+= ' class="'+args[2].value+'"';
		shortcodeData+= ' id="'+args[3].value+'"]';
		...
		for (i = 0; i < totalElements; i++) {
			...
			shortcodeData+= '[category_col_portfolio';
			shortcodeData+= ' cat_slug="'+element[0].value+'"';
			shortcodeData+= ' image="'+element[1].value+'"]';
			shortcodeData+= '[/category_col_portfolio]';
	...
	/**
	* Returns Category Column Gallery shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Category Column Gallery shortcode
	**/
	frenifyParser.buildCategoryColumnGalleryShortcode = function( args ) {
		shortcodeData = '[category_column_gallery';
		shortcodeData+= ' margin_top="'+args[0].value+'"';
		shortcodeData+= ' margin_bottom="'+args[1].value+'"';
		shortcodeData+= ' class="'+args[2].value+'"';
		shortcodeData+= ' id="'+args[3].value+'"]';
		...
		for (i = 0; i < totalElements; i++) {
			element 		= args[4].elements[i];
			shortcodeData+= '[category_col_gallery';
			shortcodeData+= ' cat_slug="'+element[0].value+'"';
			shortcodeData+= ' image="'+element[1].value+'"]';
			shortcodeData+= '[/category_col_gallery]';
	...
	* @return 		String		Tabs doable shortcode
	**/
	frenifyParser.buildAboutSliderShortcode = function( args ) {
		shortcodeData = '[about_slider';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' img_pos="'+args[1].value+'"';
		shortcodeData+= ' slide_interval="'+args[2].value+'"';
		shortcodeData+= ' autoplay="'+args[3].value+'"';
		shortcodeData+= ' title="'+args[4].value+'"';
		shortcodeData+= ' a_content="'+args[5].value+'"';
		shortcodeData+= ' link_text="'+args[6].value+'"';
		shortcodeData+= ' link_url="'+args[7].value+'"';
		shortcodeData+= ' margin_top="'+args[8].value+'"';
		shortcodeData+= ' margin_bottom="'+args[9].value+'"';
		shortcodeData+= ' class="'+args[10].value+'"';
		shortcodeData+= ' id="'+args[11].value+'"]';
	...
	* @return 		String		Tabs doable shortcode
	**/
	frenifyParser.buildServiceListShortcode = function( args ) {
		shortcodeData = '[service_list';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' cols="'+args[1].value+'"';
		shortcodeData+= ' number="'+args[2].value+'"';
		...
		for (i = 0; i < totalElements; i++) {
			element 		= args[7].elements[i];
			shortcodeData+= '[service_list_item';
			shortcodeData+= ' url="'+element[0].value+'"';
			shortcodeData+= ' title="'+element[1].value+'"';
			shortcodeData+= ' fn_content="'+element[2].value+'"]';
			shortcodeData+= '[/service_list_item]';
	...
	* @return 		String		Tabs doable shortcode
	**/
	frenifyParser.buildWotosliderShortcode = function( args ) {
		shortcodeData = '[wotoslider';
		shortcodeData+= ' purchase_button="'+args[0].value+'"';
		shortcodeData+= ' title_switch="'+args[1].value+'"';
		shortcodeData+= ' thumb_switch="'+args[2].value+'"';
		shortcodeData+= ' slide_interval="'+args[3].value+'"';
	...
	**/
	frenifyParser.buildFlowGalleryShortcode = function( args ) {
		...
		shortcodeData+= ' layout="'+args[0].value+'"';
		shortcodeData+= ' purchase_button="'+args[1].value+'"';
		shortcodeData+= ' img_title="'+args[2].value+'"';
		shortcodeData+= ' margin_top="'+args[3].value+'"';
		shortcodeData+= ' margin_bottom="'+args[4].value+'"';
		shortcodeData+= ' class="'+args[5].value+'"';
		shortcodeData+= ' id="'+args[6].value+'"]';
	...
	**/
	frenifyParser.buildPersonShortcode = function( args ) {
		...
		shortcodeData+= ' pinterest="'+args[17].value+'"';
		shortcodeData+= ' vkontakte="'+args[18].value+'"';
		shortcodeData+= ' 500px="'+args[19].value+'"';
		shortcodeData+= ' odnoklassniki="'+args[20].value+'"';
		
		shortcodeData+= ' margin_top="'+args[21].value+'"';
		shortcodeData+= ' margin_bottom="'+args[22].value+'"';
	...
	/**
	* Returns CallToAction shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		CallToAction doable shortcode
	**/
	frenifyParser.buildCallToActionShortcode = function( args ) {

		shortcodeData = '[call_to_action_fn';
		shortcodeData+= ' border_radius="'+args[0].value+'"';
		shortcodeData+= ' bg_type="'+args[1].value+'"';
		shortcodeData+= ' bggrad_direction="'+args[2].value+'"';
		shortcodeData+= ' bgcolor="'+args[3].value+'"';
		shortcodeData+= ' bggrad_from_color="'+args[4].value+'"';
		shortcodeData+= ' bggrad_to_color="'+args[5].value+'"';
		shortcodeData+= ' name="'+args[6].value+'"';
		shortcodeData+= ' link_url="'+args[7].value+'"';
		shortcodeData+= ' link_target="'+args[8].value+'"';
		shortcodeData+= ' color="'+args[9].value+'"';
		shortcodeData+= ' padding_top="'+args[10].value+'"';
		shortcodeData+= ' padding_bottom="'+args[11].value+'"';
		
		shortcodeData+= ' margin_top="'+args[12].value+'"';
		shortcodeData+= ' margin_bottom="'+args[13].value+'"';
	...
	/**
	* Returns HoverWidth shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		HoverWidth doable shortcode
	**/
	frenifyParser.buildHoverWidthShortcode = function( args ) {

		shortcodeData = '[hover_width';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' title="'+args[1].value+'"';
		shortcodeData+= ' fn_content="'+args[2].value+'"';
		shortcodeData+= ' link_url="'+args[3].value+'"';
		shortcodeData+= ' link_text="'+args[4].value+'"';
		shortcodeData+= ' img1="'+args[5].value+'"';
		shortcodeData+= ' img2="'+args[6].value+'"';
		shortcodeData+= ' img3="'+args[7].value+'"';
		shortcodeData+= ' img4="'+args[8].value+'"';
		shortcodeData+= ' img5="'+args[9].value+'"';
	...
	/**
	* Returns ImgAfterBefore shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		ImgAfterBefore doable shortcode
	**/
	frenifyParser.buildImgAfterBeforeShortcode = function( args ) {

		shortcodeData = '[img_after_before';
		shortcodeData+= ' orientation="'+args[0].value+'"';
		shortcodeData+= ' after_text="'+args[1].value+'"';
		shortcodeData+= ' before_text="'+args[2].value+'"';
		shortcodeData+= ' after_img="'+args[3].value+'"';
		shortcodeData+= ' before_img="'+args[4].value+'"';
		
		shortcodeData+= ' padding_top="'+args[5].value+'"';
		shortcodeData+= ' padding_bottom="'+args[6].value+'"';
		shortcodeData+= ' margin_top="'+args[7].value+'"';
		shortcodeData+= ' margin_bottom="'+args[8].value+'"';
		shortcodeData+= ' class="'+args[9].value+'"';
		shortcodeData+= ' id="'+args[10].value+'"]';
	...
	/**
	* Returns CallToActionClassic shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	...
	* @return 		String		CallToAction doable shortcode
	**/
	frenifyParser.buildCallToActionClassicShortcode = function( args ) {

		shortcodeData = '[call_to_action_classic_fn';
		shortcodeData+= ' title="'+args[0].value+'"';
		shortcodeData+= ' subtitle="'+args[1].value+'"';
		shortcodeData+= ' link_text="'+args[2].value+'"';
		shortcodeData+= ' link_url="'+args[3].value+'"';
		shortcodeData+= ' link_borrad="'+args[4].value+'"';
		shortcodeData+= ' link_target="'+args[5].value+'"';
		shortcodeData+= ' title_color="'+args[6].value+'"';
		shortcodeData+= ' subtitle_color="'+args[7].value+'"';
		shortcodeData+= ' link_color="'+args[8].value+'"';
		shortcodeData+= ' padding_top="'+args[9].value+'"';
		shortcodeData+= ' padding_bottom="'+args[10].value+'"';
		
		shortcodeData+= ' margin_top="'+args[11].value+'"';
		shortcodeData+= ' margin_bottom="'+args[12].value+'"';
	...
	/**
	* Returns FlipboxFn shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		FlipboxFn doable shortcode
	**/
	frenifyParser.buildFlipboxFnShortcode = function( args ) {

		shortcodeData = '[flipbox_fn';
		shortcodeData+= ' hover_effect_direction="'+args[0].value+'"';
		shortcodeData+= ' content_position="'+args[1].value+'"';
		shortcodeData+= ' border_radius="'+args[2].value+'"';
		
		shortcodeData+= ' bg_type_front="'+args[3].value+'"';
		shortcodeData+= ' bg_color_front="'+args[4].value+'"';
		shortcodeData+= ' bg_gr_degree_front="'+args[5].value+'"';
		shortcodeData+= ' bg_gr_start_front="'+args[6].value+'"';
		shortcodeData+= ' bg_gr_end_front="'+args[7].value+'"';
		shortcodeData+= ' bg_img_front="'+args[8].value+'"';
		shortcodeData+= ' title_front="'+args[9].value+'"';
		shortcodeData+= ' title_color_front="'+args[10].value+'"';
		shortcodeData+= ' content_front="'+args[11].value+'"';
		shortcodeData+= ' content_color_front="'+args[12].value+'"';
		
		shortcodeData+= ' bg_type_back="'+args[13].value+'"';
		shortcodeData+= ' bg_color_back="'+args[14].value+'"';
		shortcodeData+= ' bg_gr_degree_back="'+args[15].value+'"';
		shortcodeData+= ' bg_gr_start_back="'+args[16].value+'"';
		shortcodeData+= ' bg_gr_end_back="'+args[17].value+'"';
		shortcodeData+= ' bg_img_back="'+args[18].value+'"';
		shortcodeData+= ' title_back="'+args[19].value+'"';
		shortcodeData+= ' title_color_back="'+args[20].value+'"';
		shortcodeData+= ' content_back="'+args[21].value+'"';
		shortcodeData+= ' content_color_back="'+args[22].value+'"';
		shortcodeData+= ' link_url_back="'+args[23].value+'"';
		shortcodeData+= ' link_text_back="'+args[24].value+'"';
		shortcodeData+= ' link_color_back="'+args[25].value+'"';
		
		// default options
		shortcodeData+= ' padding_top="'+args[26].value+'"';
		shortcodeData+= ' padding_bottom="'+args[27].value+'"';	
		shortcodeData+= ' margin_top="'+args[28].value+'"';
		shortcodeData+= ' margin_bottom="'+args[29].value+'"';
		shortcodeData+= ' class="'+args[30].value+'"';
		shortcodeData+= ' id="'+args[31].value+'"]';
		shortcodeData+= '[/flipbox_fn]';

		return shortcodeData;
	}
	/**
	* Returns ButtonFn shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		ButtonFn doable shortcode
	**/
	frenifyParser.buildButtonFnShortcode = function( args ) {

		shortcodeData = '[button_fn';
		shortcodeData+= ' text="'+args[0].value+'"';
		shortcodeData+= ' url="'+args[1].value+'"';
		shortcodeData+= ' target="'+args[2].value+'"';
		shortcodeData+= ' type="'+args[3].value+'"';
		shortcodeData+= ' bg_type="'+args[4].value+'"';
		shortcodeData+= ' size="'+args[5].value+'"';
		shortcodeData+= ' animation_switch="'+args[6].value+'"';
		shortcodeData+= ' gradient_direction="'+args[7].value+'"';
		shortcodeData+= ' border_radius="'+args[8].value+'"';
		shortcodeData+= ' alignment="'+args[9].value+'"';
		shortcodeData+= ' text_color="'+args[10].value+'"';
		shortcodeData+= ' bg_color="'+args[11].value+'"';
		shortcodeData+= ' border_color="'+args[12].value+'"';
		shortcodeData+= ' grad_start_color="'+args[13].value+'"';
		shortcodeData+= ' grad_end_color="'+args[14].value+'"';
		shortcodeData+= ' arrow_color="'+args[15].value+'"';
		shortcodeData+= ' text_color_hover="'+args[16].value+'"';
		shortcodeData+= ' bg_color_hover="'+args[17].value+'"';
		shortcodeData+= ' border_color_hover="'+args[18].value+'"';
		shortcodeData+= ' grad_start_color_hover="'+args[19].value+'"';
		shortcodeData+= ' grad_end_color_hover="'+args[20].value+'"';
		shortcodeData+= ' arrow_color_hover="'+args[21].value+'"';
		
		shortcodeData+= ' margin_top="'+args[22].value+'"';
		shortcodeData+= ' margin_bottom="'+args[23].value+'"';
		shortcodeData+= ' class="'+args[24].value+'"';
		shortcodeData+= ' id="'+args[25].value+'"]';
		shortcodeData+= '[/button_fn]';
	...
	/**
	* Returns ContactInfo shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		ContactInfo doable shortcode
	**/
	frenifyParser.buildContactInfoShortcode = function( args ) {

		shortcodeData = '[contact_info';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' email_text="'+args[1].value+'"';
		shortcodeData+= ' email_own="'+args[2].value+'"';
		shortcodeData+= ' email_url="'+args[3].value+'"';
		shortcodeData+= ' call_text="'+args[4].value+'"';
		shortcodeData+= ' call_number="'+args[5].value+'"';
		shortcodeData+= ' margin_top="'+args[6].value+'"';
		shortcodeData+= ' margin_bottom="'+args[7].value+'"';
		shortcodeData+= ' padding_top="'+args[8].value+'"';
		shortcodeData+= ' padding_bottom="'+args[9].value+'"';
		shortcodeData+= ' class="'+args[10].value+'"';
		shortcodeData+= ' id="'+args[11].value+'"]';
		shortcodeData+= '[/contact_info]';
	...
	/**
	* Returns AboutMe shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		AboutMe doable shortcode
	**/
	frenifyParser.buildAboutMeShortcode = function( args ) {

		shortcodeData = '[about_me_fn';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' image_position="'+args[1].value+'"';
		shortcodeData+= ' image="'+args[2].value+'"';
		shortcodeData+= ' name="'+args[3].value+'"';
		shortcodeData+= ' occupation="'+args[4].value+'"';
		shortcodeData+= ' info_title="'+args[5].value+'"';
		
		shortcodeData+= ' info_button_text="'+args[7].value+'"';
		shortcodeData+= ' info_button_url="'+args[8].value+'"';
		shortcodeData+= ' info_button_target="'+args[9].value+'"';
		
		// social icons
		shortcodeData+= ' email="'+args[10].value+'"';
		shortcodeData+= ' facebook="'+args[11].value+'"';
		shortcodeData+= ' twitter="'+args[12].value+'"';
		shortcodeData+= ' instagram="'+args[13].value+'"';
		shortcodeData+= ' google="'+args[14].value+'"';
		shortcodeData+= ' linkedin="'+args[15].value+'"';
		shortcodeData+= ' vimeo="'+args[16].value+'"';
		shortcodeData+= ' youtube="'+args[17].value+'"';
		shortcodeData+= ' flickr="'+args[18].value+'"';
		shortcodeData+= ' skype="'+args[19].value+'"';
		shortcodeData+= ' tumblr="'+args[20].value+'"';
		shortcodeData+= ' dribbble="'+args[21].value+'"';
		shortcodeData+= ' vkontakte="'+args[22].value+'"';
		shortcodeData+= ' 500px="'+args[23].value+'"';
		shortcodeData+= ' odnoklassniki="'+args[24].value+'"';
		shortcodeData+= ' pinterest="'+args[25].value+'"';
	...
	/**
	* Returns SocialList shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		SocialList doable shortcode
	**/
	frenifyParser.buildSocialListShortcode = function( args ) {

		shortcodeData = '[social_list_fn';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' name="'+args[1].value+'"';
		
		// social icons
		shortcodeData+= ' email="'+args[2].value+'"';
		shortcodeData+= ' facebook="'+args[3].value+'"';
		shortcodeData+= ' twitter="'+args[4].value+'"';
		shortcodeData+= ' instagram="'+args[5].value+'"';
		shortcodeData+= ' google="'+args[6].value+'"';
		shortcodeData+= ' linkedin="'+args[7].value+'"';
		shortcodeData+= ' vimeo="'+args[8].value+'"';
		shortcodeData+= ' youtube="'+args[9].value+'"';
		shortcodeData+= ' flickr="'+args[10].value+'"';
		shortcodeData+= ' skype="'+args[11].value+'"';
		shortcodeData+= ' tumblr="'+args[12].value+'"';
		shortcodeData+= ' dribbble="'+args[13].value+'"';
		shortcodeData+= ' vkontakte="'+args[14].value+'"';
		shortcodeData+= ' 500px="'+args[15].value+'"';
		shortcodeData+= ' odnoklassniki="'+args[16].value+'"';
		shortcodeData+= ' pinterest="'+args[17].value+'"';
	...
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Instagram doable shortcode
	**/
	frenifyParser.buildInstagramShortcode = function( args ) {

		shortcodeData = '[instagram_fn';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' username="'+args[1].value+'"';
		shortcodeData+= ' linktext="'+args[2].value+'"';
		shortcodeData+= ' linktarget="'+args[3].value+'"';
		shortcodeData+= ' subtext="'+args[4].value+'"';
		shortcodeData+= ' images_only="'+args[5].value+'"';
		shortcodeData+= ' margin_top="'+args[6].value+'"';
		shortcodeData+= ' margin_bottom="'+args[7].value+'"';
		shortcodeData+= ' class="'+args[8].value+'"';
		shortcodeData+= ' id="'+args[9].value+'"][/instagram_fn]';
	...
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		HalfImage doable shortcode
	**/
	frenifyParser.buildHalfImageShortcode = function( args ) {
		...
		shortcodeData+= ' link_text="'+args[5].value+'"';
		shortcodeData+= ' link_url="'+args[6].value+'"';
		shortcodeData+= ' link_target="'+args[7].value+'"';
	...
	**/
	...
	frenifyParser.buildTDContentShortcode = function( args ) {
		...
		shortcodeData+= ' color="'+args[2].value+'"';
		shortcodeData+= ' margin_top="'+args[3].value+'"';
		shortcodeData+= ' margin_bottom="'+args[4].value+'"';
		shortcodeData+= ' class="'+args[5].value+'"';
		shortcodeData+= ' id="'+args[6].value+'"]';
	...
	**/
	frenifyParser.buildHotspotShortcode = function( args ) {
		...
		for (i = 0; i < totalElements; i++) {
			...
			shortcodeData+= ' bgcolor="'+element[2].value+'"';
			shortcodeData+= ' textcolor="'+element[3].value+'"';
	...
	**/
	...
	/**
	* Returns Fullpage Gallery shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Fullpage Gallery doable shortcode
	**/
	frenifyParser.buildFullPageGalleryShortcode = function( args ) {

		shortcodeData = '[fullpage_gallery';
		shortcodeData+= ' layout="'+args[0].value+'"';
		shortcodeData+= ' fn_post_type="'+args[1].value+'"';
		shortcodeData+= ' max_post_count="'+args[2].value+'"';
		...
		shortcodeData+= ' cat_slug_gallery="'+frenifyParser.getUniqueElements(args[5].value).join()+'"';
		shortcodeData+= ' exclude_cats_gallery="'+frenifyParser.getUniqueElements(args[6].value).join()+'"';
		shortcodeData+= ' order="'+args[7].value+'"';
		shortcodeData+= ' offset="'+args[8].value+'"';
		shortcodeData+= ' margin_top="'+args[9].value+'"';
		shortcodeData+= ' margin_bottom="'+args[10].value+'"';
	...
	/**
	* Returns Custompost Parallax shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Custompost Parallax doable shortcode
	**/
	frenifyParser.buildCustompostParallaxShortcode = function( args ) {

		shortcodeData = '[cuspost_parallax';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' fn_post_type="'+args[1].value+'"';
		shortcodeData+= ' max_post_count="'+args[2].value+'"';
		shortcodeData+= ' cat_slug="'+frenifyParser.getUniqueElements(args[3].value).join()+'"';
	...
	/**
	* Returns Portfolio Custom shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Portfolio Custom doable shortcode
	**/
	frenifyParser.buildPortfolioCustomShortcode = function( args ) {

		shortcodeData = '[portfolio_custom';
		shortcodeData+= ' fn_post_type="'+args[0].value+'"';
		shortcodeData+= ' layout="'+args[1].value+'"';
		shortcodeData+= ' cat_slug="'+frenifyParser.getUniqueElements(args[2].value).join()+'"';
		shortcodeData+= ' exclude_cats="'+frenifyParser.getUniqueElements(args[3].value).join()+'"';
		shortcodeData+= ' cat_slug_gallery="'+frenifyParser.getUniqueElements(args[4].value).join()+'"';
		shortcodeData+= ' exclude_cats_gallery="'+frenifyParser.getUniqueElements(args[5].value).join()+'"';
		shortcodeData+= ' order="'+args[6].value+'"';
		shortcodeData+= ' offset="'+args[7].value+'"';
		shortcodeData+= ' button_text="'+args[8].value+'"';
		shortcodeData+= ' button_url="'+args[9].value+'"';
		shortcodeData+= ' margin_top="'+args[10].value+'"';
		shortcodeData+= ' margin_bottom="'+args[11].value+'"';
		shortcodeData+= ' class="'+args[12].value+'"';
		shortcodeData+= ' id="'+args[13].value+'"]';
		shortcodeData+= '[/portfolio_custom]';
	...
	/**
	* Returns Custompost Ribbon shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Custompost Ribbon doable shortcode
	**/
	frenifyParser.buildCustompostRibbonShortcode = function( args ) {

		shortcodeData = '[custompost_ribbon';
		shortcodeData+= ' fn_post_type="'+args[0].value+'"';
		shortcodeData+= ' max_post_count="'+args[1].value+'"';
		shortcodeData+= ' cat_slug="'+frenifyParser.getUniqueElements(args[2].value).join()+'"';
		shortcodeData+= ' exclude_cats="'+frenifyParser.getUniqueElements(args[3].value).join()+'"';
		shortcodeData+= ' cat_slug_gallery="'+frenifyParser.getUniqueElements(args[4].value).join()+'"';
		shortcodeData+= ' exclude_cats_gallery="'+frenifyParser.getUniqueElements(args[5].value).join()+'"';
	...
	/**
	* Returns Custompost Carousel shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Custompost Carousel doable shortcode
	**/
	frenifyParser.buildCustompostCarouselShortcode = function( args ) {

		shortcodeData = '[custompost_carousel';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' fn_post_type="'+args[1].value+'"';
		shortcodeData+= ' title="'+args[2].value+'"';
		shortcodeData+= ' subtitle="'+args[3].value+'"';
		shortcodeData+= ' max_post_count="'+args[4].value+'"';
		shortcodeData+= ' cat_slug="'+frenifyParser.getUniqueElements(args[5].value).join()+'"';
		shortcodeData+= ' exclude_cats="'+frenifyParser.getUniqueElements(args[6].value).join()+'"';
		shortcodeData+= ' cat_slug_gallery="'+frenifyParser.getUniqueElements(args[7].value).join()+'"';
		shortcodeData+= ' exclude_cats_gallery="'+frenifyParser.getUniqueElements(args[8].value).join()+'"';
		shortcodeData+= ' order="'+args[9].value+'"';
		shortcodeData+= ' offset="'+args[10].value+'"';
		shortcodeData+= ' margin_top="'+args[11].value+'"';
		shortcodeData+= ' margin_bottom="'+args[12].value+'"';
		shortcodeData+= ' class="'+args[13].value+'"';
		shortcodeData+= ' id="'+args[14].value+'"]';
	...
	/**
	* Returns Custompost Carousel 2 shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Custompost Carousel 2 doable shortcode
	**/
	frenifyParser.buildCustompostCarouselTwoShortcode = function( args ) {

		shortcodeData = '[custompost_carousel_two';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' fn_post_type="'+args[1].value+'"';
		shortcodeData+= ' title="'+args[2].value+'"';
		shortcodeData+= ' subtitle="'+args[3].value+'"';
	...
	/**
	* Returns MultiScroll shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		MultiScroll doable shortcode
	**/
	frenifyParser.buildMultiScrollShortcode = function( args ) {

		shortcodeData = '[multi_scroll';
		shortcodeData+= ' fn_post_type="'+args[0].value+'"';
		shortcodeData+= ' max_post_count="'+args[1].value+'"';
		shortcodeData+= ' cat_slug="'+frenifyParser.getUniqueElements(args[2].value).join()+'"';
		shortcodeData+= ' exclude_cats="'+frenifyParser.getUniqueElements(args[3].value).join()+'"';
	...
	* @return 		String		Custompost Ribbon doable shortcode
	**/
	frenifyParser.buildCortexSliderShortcode = function( args ) {

		shortcodeData = '[cortex_slider';
		shortcodeData+= ' fn_post_type="'+args[0].value+'"';
		shortcodeData+= ' max_post_count="'+args[1].value+'"';
		shortcodeData+= ' cat_slug="'+frenifyParser.getUniqueElements(args[2].value).join()+'"';
		shortcodeData+= ' exclude_cats="'+frenifyParser.getUniqueElements(args[3].value).join()+'"';
	...
	/**
	* Returns Custompost Category Folder shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Custompost Category Folder shortcode
	**/
	frenifyParser.buildCustompostCategoryFolderShortcode = function( args ) {

		shortcodeData = '[cuspostcat_folder';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' animation_type="'+args[1].value+'"';
		shortcodeData+= ' fn_post_type="'+args[2].value+'"';
		shortcodeData+= ' cat_slug="'+args[3].value+'"';
		shortcodeData+= ' cat_slug_gallery="'+args[4].value+'"';
		shortcodeData+= ' order="'+args[5].value+'"';
		shortcodeData+= ' offset="'+args[6].value+'"';
		shortcodeData+= ' margin_top="'+args[7].value+'"';
		shortcodeData+= ' margin_bottom="'+args[8].value+'"';
		shortcodeData+= ' class="'+args[9].value+'"';
		shortcodeData+= ' id="'+args[10].value+'"]';
	...
	/**
	* Returns Custompost Category Modern shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Custompost Category Modern shortcode
	**/
	frenifyParser.buildCustompostCategoryModernShortcode = function( args ) {

		shortcodeData = '[cuspostcat_modern';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' fn_post_type="'+args[1].value+'"';
		shortcodeData+= ' layout="'+args[2].value+'"';
		shortcodeData+= ' cat_slug="'+args[3].value+'"';
		shortcodeData+= ' cat_slug_gallery="'+args[4].value+'"';
		shortcodeData+= ' order="'+args[5].value+'"';
		shortcodeData+= ' offset="'+args[6].value+'"';
	...
	/**
	* Returns Project Slider shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Project Slider doable shortcode
	**/
	frenifyParser.buildProjectSliderShortcode = function( args ) {

		shortcodeData = '[project_slider';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' fn_post_type="'+args[1].value+'"';
		shortcodeData+= ' max_post_count="'+args[2].value+'"';
		shortcodeData+= ' cat_slug="'+frenifyParser.getUniqueElements(args[3].value).join()+'"';
	...
	**/
	frenifyParser.buildServicetabsShortcode = function( args ) {
		...
		shortcodeData+= ' tabs_position="'+args[2].value+'"';
		shortcodeData+= ' margin_top="'+args[3].value+'"';
		shortcodeData+= ' margin_bottom="'+args[4].value+'"';
		shortcodeData+= ' class="'+args[5].value+'"';
		shortcodeData+= ' id="'+args[6].value+'"]';
		...
		for (i = 0; i < totalElements; i++) {
			...
			shortcodeData+= ' title="'+element[0].value+'"';
			shortcodeData+= ' subtitle="'+element[1].value+'"';
			shortcodeData+= ' image="'+element[2].value+'"';
			shortcodeData+= ' price_text="'+element[3].value+'"';
			shortcodeData+= ' price="'+element[4].value+'"]';
	...
	**/
	frenifyParser.buildTabsShortcode = function( args ) {
		shortcodeData = '[fotofly_fn_tabs';
		shortcodeData+= ' layout="'+args[0].value+'"';
		shortcodeData+= ' skin="'+args[1].value+'"';
		shortcodeData+= ' position="'+args[2].value+'"';
		shortcodeData+= ' margin_top="'+args[3].value+'"';
		shortcodeData+= ' margin_bottom="'+args[4].value+'"';
		shortcodeData+= ' class="'+args[5].value+'"';
		shortcodeData+= ' id="'+args[6].value+'"]';
	...
	**/
	...
	/**
	* Returns ServiceCarousel shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	...
	* @return 		String		Tabs doable shortcode
	**/
	frenifyParser.buildServiceCarouselShortcode = function( args ) {
		shortcodeData = '[service_carousel';
		shortcodeData+= ' margin_top="'+args[0].value+'"';
		shortcodeData+= ' margin_bottom="'+args[1].value+'"';
		shortcodeData+= ' class="'+args[2].value+'"';
		shortcodeData+= ' id="'+args[3].value+'"]';
		...
		for (i = 0; i < totalElements; i++) {
			element 		= args[4].elements[i];
			shortcodeData+= '[service_item';
			shortcodeData+= ' title="'+element[0].value+'"';
			shortcodeData+= ' image="'+element[1].value+'"';
			shortcodeData+= ' price_text="'+element[2].value+'"';
			shortcodeData+= ' price="'+element[3].value+'"]';
			shortcodeData+=   element[4].value;
			shortcodeData+= '[/service_item]';
	...
	**/
	frenifyParser.buildTestimonialShortcode = function( args ) {
		...
		for (i = 0; i < totalElements; i++) {
			...
			shortcodeData+= ' image="'+element[0].value+'"';
			shortcodeData+= ' name="'+element[1].value+'"';
			shortcodeData+= ' occupation="'+element[2].value+'"]';
	...
	/**
	* Returns Testimonial Single shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Testimonial Single shortcode
	**/
	frenifyParser.buildTestimonialSingleShortcode = function( args ) {
		shortcodeData = '[testimonial_single';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' layout="'+args[1].value+'"';
		shortcodeData+= ' name="'+args[2].value+'"';
		shortcodeData+= ' occupation="'+args[3].value+'"';
		shortcodeData+= ' image="'+args[4].value+'"';
		shortcodeData+= ' content_fn="'+args[5].value+'"';
		shortcodeData+= ' rating="'+args[6].value+'"';
		shortcodeData+= ' padding_top="'+args[7].value+'"';
		shortcodeData+= ' padding_bottom="'+args[8].value+'"';
		shortcodeData+= ' margin_top="'+args[9].value+'"';
		shortcodeData+= ' margin_bottom="'+args[10].value+'"';
		shortcodeData+= ' class="'+args[11].value+'"';
		shortcodeData+= ' id="'+args[12].value+'"]';
	...
	/**
	* Returns Servicetab Single shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		Servicetab Single shortcode
	**/
	frenifyParser.buildServiceTabSingleShortcode = function( args ) {
		shortcodeData = '[servicetab_single';
		shortcodeData+= ' skin="'+args[0].value+'"';
		shortcodeData+= ' img_pos="'+args[1].value+'"';
		shortcodeData+= ' title="'+args[2].value+'"';
		shortcodeData+= ' subtitle="'+args[3].value+'"';
		shortcodeData+= ' image="'+args[4].value+'"';
		shortcodeData+= ' price_text="'+args[5].value+'"';
		shortcodeData+= ' price="'+args[6].value+'"';
		shortcodeData+= ' fn_content="'+args[7].value+'"';
		shortcodeData+= ' padding_top="'+args[8].value+'"';
		shortcodeData+= ' padding_bottom="'+args[9].value+'"';
		shortcodeData+= ' margin_top="'+args[10].value+'"';
		shortcodeData+= ' margin_bottom="'+args[11].value+'"';
	...
	**/
	frenifyParser.buildTextBlockShortcode = function( args ) {
		...
		shortcodeData = '[fotofly_fn_text]'+args[0].value+'[/fotofly_fn_text]';
		return shortcodeData;
	}
	/**
	...
	**/
	frenifyParser.buildCustomTitleShortcode = function( args ) {
		shortcodeData = '[custom_title';
		shortcodeData+= ' titletype="'+args[1].value+'"';
		shortcodeData+= ' texttransform="'+args[2].value+'"';
		shortcodeData+= ' textalign="'+args[3].value+'"';
		shortcodeData+= ' textcolor="'+args[4].value+'"';
		shortcodeData+= ' margin_top="'+args[5].value+'"';
		shortcodeData+= ' margin_bottom="'+args[6].value+'"';
		shortcodeData+= ' class="'+args[7].value+'"';
		shortcodeData+= ' id="'+args[8].value+'"]';
	...
	/**
	* Returns Main Title shortcode
	*
	* @since	 	2.0.0
	*
	* @param		OBJECT 		Object having element data
	*
	* @return 		String		MainTitle doable shortcode
	**/
	frenifyParser.buildMainTitleShortcode = function( args ) {
		shortcodeData = '[main_title';
		shortcodeData+= ' t_layout="'+args[0].value+'"';
		shortcodeData+= ' title="'+args[1].value+'"';
		shortcodeData+= ' subtitle="'+args[2].value+'"';
		shortcodeData+= ' descr="'+args[3].value+'"';
		shortcodeData+= ' t_color="'+args[4].value+'"';
		shortcodeData+= ' s_color="'+args[5].value+'"';
		shortcodeData+= ' d_color="'+args[6].value+'"';
		shortcodeData+= ' margin_top="'+args[7].value+'"';
		shortcodeData+= ' margin_bottom="'+args[8].value+'"';
		shortcodeData+= ' class="'+args[9].value+'"';
		shortcodeData+= ' id="'+args[10].value+'"]';
	...
	* @return 		String		Title doable shortcode
	**/
	frenifyParser.buildCustomLinkShortcode = function( args ) {
		shortcodeData = '[custom_link';
		shortcodeData+= ' url="'+args[1].value+'"';
		shortcodeData+= ' alignment="'+args[2].value+'"';
		shortcodeData+= ' transform="'+args[3].value+'"';
		shortcodeData+= ' color="'+args[4].value+'"';
		shortcodeData+= ' margin_top="'+args[5].value+'"';
		shortcodeData+= ' margin_bottom="'+args[6].value+'"';
		shortcodeData+= ' class="'+args[7].value+'"';
		shortcodeData+= ' id="'+args[8].value+'"]';
