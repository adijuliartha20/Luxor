 ...
 */
	class fotofly_fn_CustompostRibbon extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'custompost_ribbon';
			// element name
			$this->config['name']	 		= __('Custom Post Ribbon', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "custompost_ribbon.jpg";
