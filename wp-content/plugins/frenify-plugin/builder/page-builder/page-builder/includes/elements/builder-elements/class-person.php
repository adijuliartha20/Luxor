 ...
 */
	class fotofly_fn_Person extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Person', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "person.jpg";
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.__('Person', 'frenify-core').'</sub><div class="img_frame_section">Image here</div><p class="person_name">John Doe</p></span></div>';
			$innerHtml .= '</div>';
