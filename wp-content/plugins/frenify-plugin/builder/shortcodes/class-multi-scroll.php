...
class frenifySC_MultiScroll {
	...
	public function __construct() {
		...
		// Element attributes
		add_filter( 'fotofly_fn_attr_multi_scroll-shortcode', array( $this, 'attr' ) );
		add_shortcode( 'multi_scroll', array( $this, 'render' ) );
	}
	...
	function render( $args, $content = '') {
		...
		// START OUTPUT
		$html = '';
		$html .= sprintf('<div %s>', frenifyCore_Plugin::attributes( 'multi_scroll-shortcode' ));
		
		
		// CREATING LEFT SIDE OF MULTI SCROLL
		...
		foreach ( $fotofly_fn_query->posts as $key => $fotofly_fn_portfoliopost ) {
			...
			setup_postdata( $fotofly_fn_portfoliopost ); 
				...
				$html .= '<div class="item ms-section">
							<div class="item_in">
		...
		// CREATING RIGHT SIDE OF MULTI SCROLL
	...
	function attr() {
		...
		$attr['class'] = 'fotofly_fn_w_multi_scroll';
