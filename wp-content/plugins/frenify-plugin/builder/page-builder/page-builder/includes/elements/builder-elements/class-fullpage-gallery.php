 ...
 */
	class fotofly_fn_FullPageGallery extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'fullpage_gallery';
			// element name
			$this->config['name']	 		= __('Fullpage Gallery', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "fullpage_gallery.jpg";
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array( "name" 			=> __('Layout', 'frenify-core'),
					  "desc" 			=> __('Choose the layout type for the shortcode', 'frenify-core'),
					  "id" 				=> "fotofly_fn_layout",
					  "type" 			=> ElementTypeEnum::SELECT,
					  "value" 			=> "fullscreen",
					  "allowedValues" 	=> array(
												 'halfimg' 				=> esc_html__('Half Screen Image', 'frenify-core'),
												 'fullscreen' 			=> esc_html__('Fullscreen', 'frenify-core'),
												 )
					  ),
