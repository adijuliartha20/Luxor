<?php
	 ...
	 */
	class fotofly_fn_GridTwo extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'frenify-icon frenify-icon-grid-2';
			// css class related to this element
			$this->config['css_class'] = "fotofly_fn_layout_column grid_two item-container sort-container ";
