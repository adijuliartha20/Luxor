<?php
	 ...
	 */
	class fotofly_fn_GridFourFifth extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'frenify-icon frenify-icon-grid-4-5';
			// css class related to this element
			$this->config['css_class'] = "fotofly_fn_layout_column grid_four_fifth item-container sort-container ";
