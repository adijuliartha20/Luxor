...
<div class="content_wrap">
	...
	<!-- BLOG -->
	<div class="fotofly_fn_blog_wrap blog_creative_3">
							...
							<li id="post-<?php the_ID(); ?>">
								<div <?php post_class(); ?>>
									...
									<div class="image_holder">
										<?php 
										echo fotofly_fn_callback_thumbs(1170,800);
										$full_src = '';
										if(has_post_thumbnail()){
										 	$full_src =  get_the_post_thumbnail_url(get_the_id(),'full');?>
											<div class="i_overlay" style="background-image: url(<?php echo esc_url($full_src);?>)"></div>
										<?php }else{?>
											<div class="no_image">
