...
class frenifySC_OneFifth {
	...
	public function __construct() {
		...
		add_filter( 'fotofly_fn_attr_one-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'fotofly_fn_attr_one-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', frenifyCore_Plugin::attributes( 'one-fifth-shortcode' ), frenifyCore_Plugin::attributes( 'one-fifth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'frenify-one-fifth frenify-layout-column';
