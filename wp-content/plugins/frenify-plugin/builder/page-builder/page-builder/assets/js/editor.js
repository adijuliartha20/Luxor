...
(function( $ ) {
    ...
    window['fotofly_fn_builder_tinymce_count'] = 1;
        ...
        Editor.ElementPlaceholder = Backbone.View.extend(
            {
                ...
                render: function() {
                    ...
                    //update previews
                    frenifyPreview.updatePreview( this, this.model, this.model.get( 'subElements' ) );
                ...
                openEditPanel: function() {
                    ...
                    if ( ElementName == "Slider" ) {
                        $.each(
                            $( "select[name*='fotofly_fn_slider_type']" ), function( key, value ) {
                ...
                updateElement: function() {
                    ...
                    //update previews
                    frenifyPreview.updatePreview( this, this.model, originalSubElements );
                ...
                cloneElement: function() {
                    ...
                    if ( parent != null ) {
                        ...
                        if ( parentElement.get( 'css_class' ).indexOf( 'fotofly_fn_full_width' ) > -1 ) {
                            //update ChidlrendIDs
                ...
                changeElementSize: function( direction ) {
                    ...
                    var columnSizes = [
                        ...
                        ['fotofly_fn_GridOne', '1/1', 'grid_one', '1/1', 'one_full'],
                        //['fotofly_fn_GridFiveSix', '5/6', 'grid_five_sixth', '5/6', 'five_sixth'],
                        //['fotofly_fn_GridFourFifth', '4/5', 'grid_four_fifth', '4/5', 'four_fifth'],
                        ['fotofly_fn_GridThreeFourth', '3/4', 'grid_three_fourth', '3/4', 'three_fourth'],
                        ['fotofly_fn_GridTwoThird', '2/3', 'grid_two_third', '2/3', 'two_third'],
                        //['fotofly_fn_GridThreeFifth', '3/5', 'grid_three_fifth', '3/5', 'three_fifth'],
                        ['fotofly_fn_GridTwo', '1/2', 'grid_two', '2', 'one_half'],
                        //['fotofly_fn_GridTwoFifth', '2/5', 'grid_two_fifth', '2/5', 'two_fifth'],
                        ['fotofly_fn_GridThree', '1/3', 'grid_three', '3', 'one_third'],
                        ['fotofly_fn_GridFour', '1/4', 'grid_four', '4', 'one_fourth'],
                        //['fotofly_fn_GridFive', '1/5', 'grid_five', '5', 'one_fifth'],
                        //['fotofly_fn_GridSix', '1/6', 'grid_six', '6', 'one_sixth'],
                    ];
