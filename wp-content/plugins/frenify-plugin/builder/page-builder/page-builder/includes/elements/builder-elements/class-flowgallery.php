 ...
 */
	class fotofly_fn_FlowGallery extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= esc_html__('Flow Gallery', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "flow_gallery.jpg";
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fotofly_fn_iconbox textblock_element textblock_element_style" id="fotofly_fn_flowgallery">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.esc_html__('Flow Gallery', 'frenify-core').'</sub><ul class="gallery_content"><li></li></ul></span></div>';
			$innerHtml .= '</div>';
	 	...
	 	$am_array = array();
	  	$am_array[] = array (
			...
			$this->config['subElements'] = array(
				array(
						"name" 			=> esc_html__('Flow Gallery Layout', 'frenify-core'),
					  	"id" 			=> "fotofly_fn_flow_layout",
					  	"type" 			=> ElementTypeEnum::SELECT,
					  	"value"	   		=> array('square') ,
						"allowedValues" => array(
												'square' 	=> esc_html__('Square', 'frenify-core'),
												'portrait' 	=> esc_html__('Portrait', 'frenify-core'),
												'landscape'	=> esc_html__('Landscape', 'frenify-core'))
				),
				
				array(
						"name" 			=> esc_html__('Enable/Disable Purchase Button', 'frenify-core'),
					  	"id" 			=> "fotofly_fn_purchase_button",
					  	"type" 			=> ElementTypeEnum::SELECT,
					  	"value"	   		=> array('enable') ,
						"allowedValues" => array('enable' => esc_html__('Enable', 'frenify-core'),
												'disable' => esc_html__('Disable', 'frenify-core'))
				),
				array(
						"name" 			=> esc_html__('Enable/Disable Images Title', 'frenify-core'),
					  	"id" 			=> "fotofly_fn_img_title",
					  	"type" 			=> ElementTypeEnum::SELECT,
					  	"value"	   		=> array('enable') ,
						"allowedValues" => array('enable' => esc_html__('Enable', 'frenify-core'),
												'disable' => esc_html__('Disable', 'frenify-core'))
