<?php
/**
 * Alert implementation, it extends DDElementTemplate like all other elements
 */
	class fotofly_fn_Alert extends DDElementTemplate {
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-exclamation-sign"></i><sub class="sub">'.__('Preview text will go here and custom icon choice', 'frenify-ore').'</sub><p clas="title"></p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('Alert Title', 'frenify-core'),
					  "desc" 			=> __('Insert the alert\'s title', 'frenify-core'),
					  "id" 				=> "fotofly_fn_title",
					  "type" 			=> ElementTypeEnum::INPUT,
					  "value" 			=> __('Your Title Goes Here', 'frenify-core')
					  ),							   
