 ...
 */
	class fotofly_fn_Toggle extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Toggle', 'frenify-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fotofly_fn_iconbox textblock_element textblock_element_style" id="fotofly_fn_toggle">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.__('Toggle', 'frenify-core').'</sub><ul class="toggles_content"><li>Toggle title here</li><li>Toggle title here</li><li>Toggle title here</li></ul></span></div>';
			$innerHtml .= '</div>';
	  ...
	  $am_array[] = array ( 
							array( "name"	 		=> __('Title', 'frenify-core'),
										"desc"		=> __('Insert the toggle title', 'frenify-core'),
										"id"		=> "fotofly_fn_title[0]",
										"type"		=> ElementTypeEnum::INPUT,
										"value"	   	=> array()
							),
						  array( "name"	 			=> __('Toggle Content', 'frenify-core'),
										"desc"		=> __('Insert the toggle content', 'frenify-core'),
