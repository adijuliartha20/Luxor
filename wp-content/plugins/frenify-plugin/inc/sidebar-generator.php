...
class sidebar_generator {
	...
	function __construct(){
		...
		add_action('edit_page_form', array($this, 'edit_form'), 'high');
	...
	*/
	...
	<div id='sbg-sortables' class='meta-box-sortables' style="visibility: hidden; height: 1px; overflow: hidden;">
