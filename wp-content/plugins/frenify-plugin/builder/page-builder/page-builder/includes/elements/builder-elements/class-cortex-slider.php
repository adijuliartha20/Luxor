 ...
 */
	class fotofly_fn_CortexSlider extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'cortex_slider';
			// element name
			$this->config['name']	 		= __('Cortex Slider', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "cortex_slider.jpg";
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array(
					...
					"desc"  			=> __( 'Enter the number of max posts.', 'frenify-core' ),
					"id"    			=> "max_post_count",
