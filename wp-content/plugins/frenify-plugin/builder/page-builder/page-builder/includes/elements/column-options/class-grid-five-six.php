<?php
	 ...
	 */
	class fotofly_fn_GridFiveSix extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'frenify-icon frenify-icon-grid-5-6';
			// css class related to this element
			$this->config['css_class'] = "fotofly_fn_layout_column grid_five_sixth item-container sort-container ";
