...
<div class="wrap" id="pixproof_form">
	...
	<h2><?php esc_html_e('Proofing Gallery Settings', 'frenify-core'); ?></h2>
	...
	<?php if ($processor->ok()): ?>
		...
		<?php if ( ! empty($errors)): ?>
			<br/>
			<p class="update-nag">
				<strong><?php esc_html_e('Unable to save settings.', 'frenify-core'); ?></strong>
				<?php esc_html_e('Please check the fields for errors and typos.', 'frenify-core'); ?>
			</p>
		<?php endif; ?>
		...
		<?php if ($processor->performed_update()): ?>
			<br/>
			<p class="update-nag">
				<?php esc_html_e('Settings have been updated.', 'frenify-core');?>
			</p>
		<?php endif; ?>
...
<!--			--><?php //echo $f->field('taxonomies')->render(); ?>
			...
			<button type="submit" class="button button-primary">
				<?php esc_html_e('Save Changes', 'frenify-core'); ?>
			</button>
