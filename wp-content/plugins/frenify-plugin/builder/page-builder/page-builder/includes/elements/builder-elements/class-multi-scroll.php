 ...
 */
	class fotofly_fn_MultiScroll extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'multi_scroll';
			// element name
			$this->config['name']	 		= __('Multi Scroll', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "multiscroll.jpg";
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array(
					...
					"desc"  			=> __( 'Enter max post count.', 'frenify-core' ),
					"id"    			=> "max_post_count",
