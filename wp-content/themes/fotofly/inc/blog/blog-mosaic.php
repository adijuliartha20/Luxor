...
$bgColor = $bgOpacity = $titleColor = '';
if(isset($fotofly_fn_option['blog_mosaic_bg_color'])){
	$bgColor = $fotofly_fn_option['blog_mosaic_bg_color'];
}
if(isset($fotofly_fn_option['blog_mosaic_bg_opacity'])){
	$bgOpacity = $fotofly_fn_option['blog_mosaic_bg_opacity']/100;
}
if(isset($fotofly_fn_option['blog_mosaic_title_color'])){
	$titleColor = $fotofly_fn_option['blog_mosaic_title_color'];
}
...
$styles = '
	...
	.fotofly_fn_blog_wrap.blog_mosaic .blog_wrapper ul.mypost li .title_holder span.category a:after{
		background-color: '.esc_attr($titleColor).';
	}';
?>


<!-- MAIN CONTENT -->
<div class="content_wrap" data-inlinestyles="<?php echo esc_attr($styles);?>">

	<!-- BLOG -->
	<div class="fotofly_fn_blog_wrap blog_mosaic">
						...
						<ul class="mypost">
							...
							<li id="post-<?php the_ID(); ?>">
								<div <?php post_class(); ?>>
									...
									<?php if(isset($fotofly_fn_option['blog_mosaic_bg_switch']) && $fotofly_fn_option['blog_mosaic_bg_switch'] !== 'disable'){ ?>
									<div class="overlay_color" style="background-color: <?php echo esc_attr($bgColor);?>; opacity:<?php echo esc_attr($bgOpacity);?>">
