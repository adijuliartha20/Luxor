<?php
	 ...
	 */
	class fotofly_fn_GridTwoFifth extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'frenify-icon frenify-icon-grid-2-5';
			// css class related to this element
			$this->config['css_class'] = "fotofly_fn_layout_column grid_two_fifth item-container sort-container ";
