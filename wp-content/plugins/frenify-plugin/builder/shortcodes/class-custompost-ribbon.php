<?php
class frenifySC_CustompostRibbon {
	...
	public function __construct() {
		...
		// Element attributes
		add_filter( 'fotofly_fn_attr_custompost_ribbon-shortcode', array( $this, 'attr' ) );
		add_shortcode( 'custompost_ribbon', array( $this, 'render' ) );
	}
	...
	function render( $args, $content = '') {
		...
		// START OUTPUT
		$html = '';
		$html .= sprintf('<div %s>', frenifyCore_Plugin::attributes( 'custompost_ribbon-shortcode' ));
		
		$html .= '<div class="container"><div class="flexslider"><ul class="slides">';
	...
	function attr() {
		...
		$attr['class'] = 'fotofly_fn_w_custompost_ribbon_wrap';
...
new frenifySC_CustompostRibbon();