 ...
 */
	class fotofly_fn_Accordion extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Accordion', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "accordion.jpg";
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fotofly_fn_iconbox textblock_element textblock_element_style" id="fotofly_fn_Accordion">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.__('Accordion', 'frenify-core').'</sub><ul class="toggles_content"><li>Toggle title here</li><li>Toggle title here</li><li>Toggle title here</li></ul></span></div>';
			$innerHtml .= '</div>';
	  ...
	  $am_array[] = array ( 
							array( "name"	 		=> __('Title', 'frenify-core'),
										"desc"		=> __('Insert the accordion title', 'frenify-core'),
										"id"		=> "fotofly_fn_title[0]",
										"type"		=> ElementTypeEnum::INPUT,
										"value"	   	=> array()
							),
						  array( "name"	 			=> __('Open by Default', 'frenify-core'),
										"desc"		=> __('Choose to have the accordion open when page loads', 'frenify-core'),
										"id"		=> "fotofly_fn_open[0]",
										"type"		=> ElementTypeEnum::SELECT,
										"value"	   	=> array('no') ,
									  	"allowedValues"   => array('no'	 => __('No', 'frenify-core'),
																'yes'	 => __('Yes', 'frenify-core'))
							),
						  array( "name"	 			=> __('Accordion Content', 'frenify-core'),
										"desc"		=> __('Insert the accordion content', 'frenify-core'),
