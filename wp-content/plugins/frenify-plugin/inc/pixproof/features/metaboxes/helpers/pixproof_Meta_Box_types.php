...
class pixproof_Meta_Box_types {
	...
	private static function repeat_table_close() {
		echo '</tbody></table><p class="add-row"><a data-selector="', pixproof_Meta_Box::$field['id'] ,'_repeat" class="add-row-button button" href="#">'. esc_html__( 'Add Row', 'frenify-core' ) .'</a></p>';
	}
	...
	private static function repeat_cell( $input ) {
		return '<td>'. $input .'</td><td class="remove-row"><a class="button remove-row-button" href="#">'. esc_html__( 'Remove', 'frenify-core' ) .'</a></td>';
	}
	...
	public static function file_list( $field, $meta, $object_id ) {
		...
		echo '<input class="pixproof_upload_button button pixproof_upload_list" type="button" value="'. esc_html__( 'Add or Upload File', 'frenify-core' ) .'" />', self::desc( true );
			...
			foreach ( $meta as $id => $fullurl ) {
				if ( self::is_valid_img_ext( $fullurl ) ) {
					...
					'<li class="img_status">',
						...
						'<p><a href="#" class="pixproof_remove_file_button">'. esc_html__( 'Remove Image', 'frenify-core' ) .'</a></p>
					...
					echo
					'<li>',
					esc_html__( 'File:', 'frenify-core' ), ' <strong>', $title, '</strong>&nbsp;&nbsp;&nbsp; (<a href="', $fullurl, '" target="_blank" rel="external">'. esc_html__( 'Download', 'frenify-core' ) .'</a> / <a href="#" class="pixproof_remove_file_button">'. esc_html__( 'Remove', 'frenify-core' ) .'</a>)
						<input type="hidden" id="filelist-', $id ,'" name="', $field['id'] ,'[', $id ,']" value="', $fullurl ,'" />
					</li>';
				}
			}
	...
	public static function file( $field, $meta, $object_id, $object_type ) {
		...
		echo '<input class="pixproof_upload_button button" type="button" value="'. esc_html__( 'Add or Upload File', 'frenify-core' ) .'" />';
		...
		'<div id="', $field['id'], '_status" class="pixproof_media_status">';
			if ( ! empty( $meta ) ) {
				...
				if ( self::is_valid_img_ext( $meta ) ) {
					...
					echo '<p><a href="#" class="pixproof_remove_file_button" rel="', $field['id'], '">'. esc_html__( 'Remove Image', 'frenify-core' ) .'</a></p>';
					echo '</div>';
				} else {
					...
					echo esc_html__( 'File:', 'frenify-core' ), ' <strong>', $title, '</strong>&nbsp;&nbsp;&nbsp; (<a href="', $meta, '" target="_blank" rel="external">'. esc_html__( 'Download', 'frenify-core' ) .'</a> / <a href="#" class="pixproof_remove_file_button" rel="', $field['id'], '">'. esc_html__( 'Remove', 'frenify-core' ) .'</a>)';
				}
			}
		echo '</div>';
	}
