					...
					<div class="blog_content" data-blog-column="<?php echo esc_attr($fotofly_fn_blog_column); ?>">
						<ul class="fotofly_fn_masonry mypost">
							...
							<li class="fotofly_fn_masonry_in" id="post-<?php the_ID(); ?>">
								<div <?php post_class(); ?>>
									<?php 
										if(isset($fotofly_fn_option['blog_grid_type'])){
											$grid_type 	= $fotofly_fn_option['blog_grid_type'];
										}else{
											$grid_type 	= '';
										}
									...
									<?php 
										...
										// $_GET EDITION
										$blog_format_icon = $fotofly_fn_option['blog_format_display'];
										if(isset($_GET['icon'])){$blog_format_icon = $_GET['icon'];}
										// $_GET EDITION
									
										if($blog_format_icon == 'enable'){
