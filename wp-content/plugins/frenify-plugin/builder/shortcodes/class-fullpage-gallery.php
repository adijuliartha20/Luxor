<?php
class frenifySC_FullPageGallery {
	...
	public function __construct() {
		...
		// Element attributes
		add_filter( 'fotofly_fn_attr_fullpage_gallery-shortcode', array( $this, 'attr' ) );
		add_shortcode( 'fullpage_gallery', array( $this, 'render' ) );
	}
	...
	function render( $args, $content = '') {
		...
		// START OUTPUT
		$html = '';
		$html .= sprintf('<div %s><div class="fotofly_fn_galleryblock">', frenifyCore_Plugin::attributes( 'fullpage_gallery-shortcode' ));
		
		
		// HALF SCREEN IMAGE
		if($layout == '' || $layout == 'halfimg') /* ::::::::::::::::::::::: HALF SCREEN IMAGE ::::::::::::::::::::::::: */
		{
			
			$html .= '<div class="fotofly_fn_galleryblock_halfimg"><div class="fotofly_fn_fullpagejs">';
				...
				setup_postdata( $fotofly_fn_portfoliopost ); 
					...
					$html   				   .= '<div class="item section">
														<div class="fotofly_fn_first_half">
															...
															<div class="img_holder_bg" style="background-image:url('.$post_thumbnail_url.')">
															</div>
					...
					$date = $cat_list = $gallery_list = NULL; 
			}
			wp_reset_postdata(); 
		...
		{
			$html .= '<div class="fotofly_fn_galleryblock_fullscreen"><div class="fotofly_fn_fullpagejs">';
			...
			foreach ( $fotofly_fn_query->posts as $fotofly_fn_portfoliopost ) {
				setup_postdata( $fotofly_fn_portfoliopost ); 
					...
					$html   				   .= '<div class="item section">
														...
														<div class="img_holder_bg" style="background-image:url('.$post_thumbnail_url.')" ></div>			
													</div>';
					$date = $cat_list = $gallery_list = NULL; 
			}
			wp_reset_postdata(); 
	...
	function attr() {
		...
		$attr['class'] = 'fotofly_fn_w_fullpage_gallery_wrap';
