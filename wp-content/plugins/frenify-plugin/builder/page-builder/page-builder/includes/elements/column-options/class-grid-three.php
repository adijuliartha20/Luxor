<?php
	 ...
	 */
	class fotofly_fn_GridThree extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'frenify-icon frenify-icon-grid-3';
			// element icon
			$this->config['icon_url'] = "icons/sc-three.png";
			// css class related to this element
			$this->config['css_class'] = "fotofly_fn_layout_column grid_three item-container sort-container ";
