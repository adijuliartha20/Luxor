 ...
 */
	class fotofly_fn_MainTitle extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   		= 'main_title';
			// element name
			$this->config['name']	 		= __('Main Title', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "main_title.jpg";
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fotofly_fn_iconbox textblock_element textblock_element_style" id="fotofly_fn_idmaintitle">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><sub class="title_text align_right">'.__('Main Title', 'frenify-core').'</sub></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('Title Layout', 'frenify-core'),
					  "desc" 			=> '',
					  "id" 				=> "fotofly_fn_titlelayout",
				...
				array("name" 			=> __('Subtitle', 'frenify-core'),
					  "desc"			=> __('Insert the subtitle text', 'frenify-core'),
					  "id" 				=> "fotofly_fn_subtitle_name",
					  "type" 			=> ElementTypeEnum::INPUT,
					  "value" 			=> "" 
					  ),
				
				array("name" 			=> __('Description', 'frenify-core'),
					  "desc"			=> __('Insert the description', 'frenify-core'),
					  "id" 				=> "fotofly_fn_descr_name",
				...
				array("name" 			=> __('Subtitle Color', 'frenify-core'),
					  "desc" 			=> __('Set the color of the subtitle.', 'frenify-core'),
					  "id" 				=> "fotofly_fn_subtitle_color",
					  "type" 			=> ElementTypeEnum::COLOR,
					  "value" 			=> "#999"
					  ),
