...
$img_pos = '';
$img_pos = $fotofly_fn_option['p_single_sticky'];
...
if(isset($img_pos) && $img_pos !== ''){
	$img_pos = $img_pos;
}
if(isset($_GET['ps_sticky_pos'])){$img_pos = $_GET['ps_sticky_pos'];}
// Start Post
...
<div class="fotofly_fn_content_part" <?php echo esc_attr($fotofly_fn_page_spaces);?>>
		...
		<div class="content_wrap">
			...
			<div class="fotofly_fn_psingle_sticky" data-img-pos="<?php echo esc_attr($img_pos); ?>">
				 <div class="image_part sticky_sidebar">
				 	<ul class="frenify_fn_lightbox">
				 		 <?php
				 ...
				 <div class="content_part sticky_sidebar">
				 	<div class="in">
