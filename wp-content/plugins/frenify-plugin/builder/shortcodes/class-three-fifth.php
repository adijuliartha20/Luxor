...
class frenifySC_ThreeFifth {
	...
	public function __construct() {
		...
		add_filter( 'fotofly_fn_attr_three-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'fotofly_fn_attr_three-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', frenifyCore_Plugin::attributes( 'three-fifth-shortcode' ), frenifyCore_Plugin::attributes( 'three-fifth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'frenify-three-fifth frenify-layout-column';
