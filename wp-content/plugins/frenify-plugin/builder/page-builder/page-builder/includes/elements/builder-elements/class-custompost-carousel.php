 ...
 */
	class fotofly_fn_CustompostCarousel extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'custompost_carousel';
			// element name
			$this->config['name']	 		= esc_html__('Custom Post Carousel', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "custompost_carousel.jpg";
