...
class frenifySC_FourFifth {
	...
	public function __construct() {
		...
		add_filter( 'fotofly_fn_attr_four-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'fotofly_fn_attr_four-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', frenifyCore_Plugin::attributes( 'four-fifth-shortcode' ), frenifyCore_Plugin::attributes( 'four-fifth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'frenify-four-fifth frenify-layout-column';
