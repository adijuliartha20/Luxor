<?php
class frenifySC_CustompostCarousel {
	...
	public function __construct() {
		...
		// Element attributes
		add_filter( 'fotofly_fn_attr_custompost_carousel-shortcode', array( $this, 'attr' ) );
		add_shortcode( 'custompost_carousel', array( $this, 'render' ) );
	}
	...
	function render( $args, $content = '') {
		...
		$title = $subtitle = $owl_control = '';
		$title 			= '<h2>'.self::$args['title'].'</h2>';
		$subtitle 		= '<p>'.self::$args['subtitle'].'</p>';
		...
		$title_holder	= '<div class="title_wrapper"><div class="container"><div class="main_title_holder">'.$title.$subtitle.$owl_control.'</div></div></div>';
		// START OUTPUT
		$html = '';
		$html .= sprintf('<div %s>', frenifyCore_Plugin::attributes( 'custompost_carousel-shortcode' ));
		
		$html .= '<div class="w_cpost_carousel">'.$title_holder.'<div class="owl-carousel">';
				...
				$html .= '
						<div class="item">
							<div class="image_holder">
								'.fotofly_fn_callback_thumbs(800, 970).'
							</div>
	...
	function attr() {
		...
		$attr['class'] = 'fotofly_fn_w_custompost_carousel_wrap';
...
new frenifySC_CustompostCarousel();