 ...
 */
	class fotofly_fn_Wotoslider extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'wotoslider_box';
			// element name
			$this->config['name']	 		= esc_html__('Wotoslider', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "woto_slider.jpg";
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fotofly_fn_iconbox textblock_element textblock_element_style" id="fotofly_fn_flexslider">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.__('Wotoslider', 'frenify-core').'</sub><ul class="gallery_content"><li></li></ul></span></div>';
			$innerHtml .= '</div>';
		...
		$reverse_choices			= frenifyHelper::get_reversed_choice_data();
	 	...
	 	$am_array = array();
	  	$am_array[] = array (
							...
							array(
									"name"  	=> esc_html__( 'Insert Image Title', 'frenify-core' ),
			...
			$this->config['subElements'] = array(
				...
				array(
						"name" 			=> esc_html__('Enable/Disable Title', 'frenify-core'),
					  	"id" 			=> "title_switch",
					  	"type" 			=> ElementTypeEnum::SELECT,
					  	"value"	   		=> array('enable'),
						"allowedValues" => array(	'enable' 	=> esc_html__('Enable', 'frenify-core'),
				...
				array(
						"name" 			=> esc_html__('Enable/Disable Thumbnails Pabel', 'frenify-core'),
					  	"id" 			=> "thumb_switch",
					  	"type" 			=> ElementTypeEnum::SELECT,
					  	"value"	   		=> array('enable'),
						"allowedValues" => array(	'enable' 	=> esc_html__('Enable', 'frenify-core'),
