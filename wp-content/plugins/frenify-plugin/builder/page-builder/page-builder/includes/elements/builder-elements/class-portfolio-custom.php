 ...
 */
	class fotofly_fn_PortfolioCustom extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'portfolio_custom';
			// element name
			$this->config['name']	 		= __('Portfolio Custom', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "portfolio_custom.jpg";
			...
			$this->config['subElements'] = array(
			   ...
			   array( "name" 			=> __('Layout', 'frenify-core'),
					  ...
					  "allowedValues" 	=> array('triple' 				=> __('Triple', 'frenify-core'),
												 'quadruple' 			=> __('Quadruple', 'frenify-core'),
												 'quintuple' 			=> __('Quintuple', 'frenify-core'),
												 )
					  ),
