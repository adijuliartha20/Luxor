...
( function ( $ ) {
	"use strict";
	$.frenifyCustomTemplates = ( function () {
		
		var SaveTemplateHandler 	= $( '#fotofly_fn_save_custom_tpl' );
		var loadTemplateHanlder 	= $( '.fotofly_fn_load_template' );
		var deleteTemplateHanlder 	= $( '.fotofly_fn_delete_template' );
		...
		$( document ).ready( function () {
			...
			function checkIfTemplateExists ( tpl_name ) {
				...
				$('.fotofly_fn_custom_template').each(function(i, obj) {
					var name = $(obj).text();
			...
			function SaveCustomTemplate( ) {
				...
				var content = frenifyParser.parseColumnOptions();
				//prepare data
				var data = {
						action	  : 'fotofly_fn_custom_tabs',
	...
	$(document).ready(function () {
		...
		$.frenifyCustomTemplatesObj = new $.frenifyCustomTemplates();
	});
