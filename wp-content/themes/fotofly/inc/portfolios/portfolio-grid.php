						...
						>
							...
							<li class="fotofly_fn_masonry_in fotofly_fn_item_wrap">
								<div class="fotofly_fn_item">
									...
									?>
									<?php 
										if(isset($fotofly_fn_option['portfolio_grid_type'])){
											$grid_type 	= $fotofly_fn_option['portfolio_grid_type'];
										}else{
											$grid_type 	= 'portrait';
										}
										...
										$imageURL 	= get_the_post_thumbnail_url(get_the_id(),'fotofly_fn_thumb-800-800');
									...
									<div class="cover_image_wrap">
										...
										<div class="fn_overlay_hover">
											...
											<a href="<?php the_permalink();?>">
												<div data-fn-bg-img="<?php echo esc_url($imageURL);?>"></div>
											</a>
										</div>
										<!-- /fn_overlay -->
										...
										<div class="cover_image">
											...
											<a href="<?php the_permalink();?>"><div data-fn-bg-img="<?php echo esc_url($imageURL);?>"></div></a>
										</div>
