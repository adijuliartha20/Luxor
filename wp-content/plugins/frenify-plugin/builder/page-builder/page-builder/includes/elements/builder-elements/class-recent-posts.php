 ...
 */
	class fotofly_fn_RecentPosts extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Recent Posts', 'frenify-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.__('Recent Posts', 'frenify-core').'</sub><p class="recent_posts"><span>5</span> '.__('Posts', 'frenify-core').'</p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('Number of Posts', 'frenify-core'),
					  "desc" 			=> __('Select the number of posts to display', 'frenify-core'),
					  "id" 				=> "post_number",
					  "type" 			=> ElementTypeEnum::INPUT,
					  "value" 			=> "3"
					  ),
				array("name" 			=> __('Background Image', 'frenify-core'),
