...
$intro_info = $intro_content_color = $intro_name_color = $intro_name = $intro_sign = $content_pos = $intro_text_color = $intro_text = $intro_profile_img = $styles = '';
...
// content position
if(isset($fotofly_fn_option['intro_about_pos']) && $fotofly_fn_option['intro_about_pos'] !== ''){
	$content_pos = $fotofly_fn_option['intro_about_pos'];
}
...
?>
<!-- ABOUT -->
<div class="about" data-inlinestyles="<?php echo esc_attr($styles);?>">
	
	
	<div class="bg" style="background-image: url(<?php echo esc_attr($intro_profile_img); ?>)"></div>
	
	<div class="content <?php echo esc_attr($content_pos); ?>">
