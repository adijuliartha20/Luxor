 ...
 */
	class fotofly_fn_Countdown extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Countdown', 'frenify-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fotofly_fn_iconbox textblock_element textblock_element_style" id="fotofly_fn_countdown">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.__('Countdown', 'frenify-core').'</sub><div class="countdown_section">Countdown Box</div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('Time', 'frenify-core'),
					  "desc"			=> __('Insert the end time. Example: 09:50', 'frenify-core'),
					  "id" 				=> "fotofly_fn_time",
					  "type" 			=> ElementTypeEnum::INPUT,
					  "value" 			=> "09:50" 
					  ),
					  
				array("name" 			=> __('Date', 'frenify-core'),
