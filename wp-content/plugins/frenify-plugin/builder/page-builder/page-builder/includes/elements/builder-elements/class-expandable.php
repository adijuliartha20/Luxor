 ...
 */
	class fotofly_fn_Expandable extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Expandable', 'frenify-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fotofly_fn_iconbox textblock_element textblock_element_style" id="fotofly_fn_expandable">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.__('Expandable', 'frenify-core').'</sub><div class="expandable_section">Expandable Box</div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name"	  		=> __('Content', 'frenify-core'),
							  "desc"	=> __('Enter the content to be displayed', 'frenify-core'),
