...
class frenifySC_FiveSixth {
	...
	public function __construct() {
		...
		add_filter( 'fotofly_fn_attr_five-sixth-shortcode', array( $this, 'attr' ) );
		add_filter( 'fotofly_fn_attr_five-sixth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', frenifyCore_Plugin::attributes( 'five-sixth-shortcode' ), frenifyCore_Plugin::attributes( 'five-sixth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'frenify-five-sixth frenify-layout-column';
