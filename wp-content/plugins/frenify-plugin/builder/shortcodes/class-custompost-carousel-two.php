<?php
class frenifySC_CustompostCarouselTwo {
	...
	public function __construct() {
		...
		// Element attributes
		add_filter( 'fotofly_fn_attr_custompost_carousel_two-shortcode', array( $this, 'attr' ) );
		add_shortcode( 'custompost_carousel_two', array( $this, 'render' ) );
	}
	...
	function render( $args, $content = '') {
		...
		$title_holder	= '<div class="title_wrapper"><div class="main_title_holder">'.$title.$subtitle.$owl_control.'</div></div>';
		// START OUTPUT
		$html = '';
		$html .= sprintf('<div %s>', frenifyCore_Plugin::attributes( 'custompost_carousel_two-shortcode' ));
		
		$html .= '<div class="w_cpost_carousel c2">'.$title_holder.'<div class="owl-carousel">';
				...
				$html .= '
						<div class="item">
							<div class="image_holder">
								'.fotofly_fn_callback_thumbs(570, 700).'
							</div>
	...
	function attr() {
		...
		$attr['class'] = 'fotofly_fn_w_custompost_carousel_2';
...
new frenifySC_CustompostCarouselTwo();