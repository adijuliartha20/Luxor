 ...
 */
	class fotofly_fn_CustompostParallax extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'cuspost_parallax';
			// element name
			$this->config['name']	 		= __('Custompost Parallax', 'frenify-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// preview image
			$this->config['preview_img']  	= "custompost_parallax.jpg";
