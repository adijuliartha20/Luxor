 ...
 */
	class fotofly_fn_Client extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Clients', 'frenify-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="fotofly_fn_iconbox textblock_element textblock_element_style" id="fotofly_fn_client">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="fotofly_fn_iconbox_icon"><i class="frenifya-expand-alt"></i><sub class="sub">'.__('Clients', 'frenify-core').'</sub><ul class="client_content"><li></li></ul></span></div>';
			$innerHtml .= '</div>';
		...
		$reverse_choices			= frenifyHelper::get_reversed_choice_data();
	 	...
	 	$am_array = array();
	  	$am_array[] = array (
							array(
										"name"  	=> 	__( 'Client Link', 'frenify-core' ),
										"desc"  	=> 	__( 'Set client url', 'frenify-core' ),
			...
			$this->config['subElements'] = array(
				...
				array(
					"name"  => __( 'Client Template', 'frenify-core' ),
					"id"    => "client_type",
				...
				array(
					"name"  => __( 'Client Columns', 'frenify-core' ),
					"id"    => "client_col",
					"type"  => ElementTypeEnum::SELECT,
					"value" => "5",
					"allowedValues" => array(
				...
				array(
					"name"  => __( 'Color', 'frenify-core' ),
					"id"    => "client_color",
					"type"  => ElementTypeEnum::COLOR,
					"value" => "#000000",
				),
				array(
					"name"  => __( 'Color Transparency', 'frenify-core' ),
					"id"    => "client_opacity",
					"type"  => ElementTypeEnum::SELECT,
					"value" => "0.9",
					"allowedValues" => array(
