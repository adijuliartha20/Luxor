...
(function() {
	tinymce.create('tinymce.plugins.tfbutton', {
		init : function(ed, url) {
			fotofly_fn_shortcode_url = url;
		},
		createControl : function(n, cm) {
			switch(n) {
				case 'tfbutton':
					var c = cm.createSplitButton('tfbutton', {
						title : 'Frenify Shortcodes',
						image : fotofly_fn_shortcode_url+'/tfbutton.png'
					});
					...
					c.onRenderMenu.add(function(c, m) {
						...
						m.add({
							title : 'Content Boxes',
							icon: 'fotofly_fn_content_boxes',
							onclick : function() {
								tinyMCE.activeEditor.selection.setContent('[content_boxes layout="icon-with-title, icon-on-top, icon-on-side, icon-boxed" iconcolor="" circlecolor="" circlebordercolor="" backgroundcolor=""]<br />[content_box title="Responsive Design" icon="tablet" image="" link="http://themeforest.net/user/frenify" linktarget="" linktext="Learn More"]frenify is fully responsive and can adapt to any screen size. Try resizing your browser window to see the adaptation.[/content_box]<br />[content_box title="Awesome Sliders" icon="thumbs-up" image="" link="http://themeforest.net/user/frenify" linktarget="" linktext="Learn More"]frenify includes the awesome Layer Parallax Slider as well as the popular FlexSlider2. Both are super easy to use![/content_box]<br />[content_box title="Unlimited Colors"  icon="magic" image="" link="http://themeforest.net/user/frenify" linktarget="" linktext="Learn More"]We included a backend color picker for unlimited color options. Anything can be changed, including the gradients![/content_box]<br />[content_box last="yes" title="500+ Google Fonts" icon="beaker" image="" link="http://themeforest.net/user/frenify" linktarget="" linktext="Learn More"]frenify loves fonts, choose from over 500+ Google Fonts. You can change all headings and body copy with ease![/content_box]<br />[/content_boxes]');
							}
						});

						m.add({
							title : 'Counters Circle',
							icon: 'fotofly_fn_counters_circle',
							onclick : function() {
						...
						m.add({
							title : 'Tagline Box',
							icon: 'fotofly_fn_tagline',
							onclick : function() {
								tinyMCE.activeEditor.selection.setContent('[tagline_box backgroundcolor="" shadow="no" shadowopacity="0.1-1" border="1px" bordercolor="" highlightposition="right, left, top or bottom" link="http://themeforest.net/user/frenify" linktarget="" buttoncolor="e.g. green, darkgreen, orange, blue, red, pink, darkgray, lightgray or leave blank" button="Purchase Now" title="frenify is incredibly responsive, with a refreshingly clean design" description="And it has some awesome features, premium sliders, unlimited colors, advanced theme options and so much more!"][/tagline_box]');
							}
						});

						m.add({
							title : 'Tooltip',
							icon: 'fotofly_fn_tooltip',
							onclick : function() {
